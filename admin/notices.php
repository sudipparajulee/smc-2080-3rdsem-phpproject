    ...
    <table class="w-full">
        ...
        <tr class="text-center">
            ...
            <td class="p-2 border">
                ...
                <a href="actionnotice.php?deleteid=<?php echo $row['id']; ?>" class="bg-red-600 text-white px-2 py-1 rounded-lg mx-1" onclick="return confirm('Are you sure to delete?')">Delete</a>
            </td>
        </tr>
        <?php } ?>
    </table>
